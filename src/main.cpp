...
uint256 hashGenesisBlock("0x00000e4fc293a1912b9d73cbb8d8f7270007a7d84382f1370661e65d5d57b1f6");
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 520000) { DiffMode = 2; }
...
{
    // Bolivarcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0x7c652ccc9dcdd33eee6c45c93b2008ccb4f6526f13fc7dcc69fe78d6e70c76e8"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc3, 0xb9, 0xde }; // Bolivarcoin: increase each by adding 6 to bitcoin's value.
