 ...
 *
 *   // network
 *   CBolivarcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bolivarcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBolivarcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBolivarcoinNetwork(UniValue objIn)
    {
...
// // can be under: BolivarcoinNetwork
// //   -- signature requirements : Key1(User)
// class CBolivarcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BolivarcoinNetwork);
//     // }
