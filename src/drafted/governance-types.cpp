...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BolivarcoinNetwork") type = BolivarcoinNetwork;
    if(strType == "BolivarcoinNetworkVariable") type = BolivarcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BolivarcoinNetwork) s = "BolivarcoinNetwork";
    if(type == BolivarcoinNetworkVariable) s = "BolivarcoinNetworkVariable";
