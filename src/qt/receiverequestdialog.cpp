...
#include "config/bolivarcoin-config.h" /* for USE_QRCODE */
#endif
...
{
    ui->setupUi(this);
    this->setStyleSheet("background-color: #F7F5F3;");
...
void ReceiveRequestDialog::update()
{
    ...
    QString html;
    html += "<html> <body style='background-color:#F7F5F3'> <font color='#000' face='verdana, arial, helvetica, sans-serif'>";
