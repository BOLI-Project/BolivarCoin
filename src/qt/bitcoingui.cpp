    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bolivarcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bolivarcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bolivarcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bolivarcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bolivarcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a bolivarcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bolivarcoin Core help message to get a list with possible Bolivarcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bolivarcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Bolivarcoin Core"); // default title
    ...
    // Append title to "Bolivarcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
