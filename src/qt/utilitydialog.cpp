    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bolivarcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bolivarcoin Core"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color:#000' href=\"\\1\">\\1</a>");
...
All the Bolivarcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BOLI, 0.1 BOLI, 1 BOLI and 10 BOLI -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bolivarcoin Core is shutting down...") + "<br /><br />" +
