...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bolivarcoin Core bolivarcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bolivarcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bolivarcoin transaction") + "\n" +
              "  bolivarcoin-tx [options] -create [commands]   " + _("Create hex-encoded bolivarcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bolivarcoin transaction
