...
#ifndef BOLIVARCOIN_NET_H
#define BOLIVARCOIN_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in Bolivarcoin,
    // because it's used in many Bolivarcoin-specific places (masternode, privatesend).
