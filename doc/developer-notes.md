...
Bolivarcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Bolivarcoin Core, where everyone uses
...
pay attention to for reviewers of Bolivarcoin Core code.

General Bolivarcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bolivarcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
