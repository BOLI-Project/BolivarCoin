...
Only requiring some minor changes is bolivarcoin.cpp.
...
Changes to bolivarcoin.cpp
----------------------
bolivarcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
