...
This mechanism has been integrated into Bitcore-Node-Bolivarcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bolivarcoinpay/insight-api-bolivarcoin#web-socket-api](https://github.com/bolivarcoinpay/insight-api-bolivarcoin#web-socket-api)
* API: [https://github.com/bolivarcoinpay/insight-api-bolivarcoin#instantsend-transactions](https://github.com/bolivarcoinpay/insight-api-bolivarcoin#instantsend-transactions)
...
By default, the Bolivarcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bolivarcoin Core daemon:
